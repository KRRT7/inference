...
def test_benchmark_equivalent(benchmark, dataset_reference):
    ...
    # model_type = get_model_type(model_id="yolov8n-seg-640", api_key=None)
    model = get_model(
        model_id="yolov8n-seg-640", api_key=None
    )  # specifically inference.models.yolov8.yolov8_instance_segmentation.YOLOv8InstanceSegmentation
